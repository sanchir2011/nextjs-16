...
export default function Login() {
  ...
  const handleLogin = async (e: any) => {
    ...
    setLoading(false)
    if(!response || response.ok === false) return toast.error('Нэвтрэхэд алдаа гарлаа')
    ...
    <div className="w-full p-6 sm:w-[380px] sm:p-0">
      ...
      <div className="mt-6">
        <div className="space-y-4 grid grid-cols-2">
          <Input label='Имэйл хаяг' type='email' placeholder='Таны имэйл хаяг' onChange={handleEmailChange} onKeyDown={handleKeyDown} required autoFocus container="col-span-full" />

          <div className='col-span-full'>
            <Input label='Нууц үг' type='password' placeholder='Таны нууц үг' onChange={handlePasswordChange} onKeyDown={handleKeyDown} required container="w-full" />
            <div className="flex items-center justify-end mt-1">
              <div className="text-xs leading-6">
                <Link href="/forgot" className="font-medium text-muted-foreground hover:text-foreground transition">
