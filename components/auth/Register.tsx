...
export default function Register() {
  ...
  const signInWithGoogle = async () => {
    if(redirectUrl) return await signIn('google', { callbackUrl: redirectUrl })
    await signIn('google')
  }
    ...
    <div className="w-full p-6 sm:w-[380px] sm:p-0">
      ...
      <div className="mt-6">
        <div className="space-y-4 grid grid-cols-2 gap-x-4">
          <Input label="Имэйл хаяг" type="email" placeholder="Таны имэйл хаяг" onChange={handleEmailChange} autoFocus required container="col-span-full" />
          <Input label="Овог" placeholder="Таны овог" onChange={handleLastNameChange} required container="col-span-full sm:col-span-1" />
          <Input label="Нэр" placeholder="Таны нэр" onChange={handleFirstNameChange} required container="col-span-full sm:col-span-1" />
          <Input label="Шинэ нууц үг" type="password" placeholder="Таны шинэ нууц үг" onChange={handlePasswordChange} onKeyDown={handleKeyDown} description='8-аас дээш тэмдэгтэй байх ёстой' required container="col-span-full" />
        ...
        <div className="mt-6 grid grid-cols-1 gap-4">
          <Button onClick={signInWithGoogle} loadingMessage="Нэвтэрч байна..." isLoading={loading} variant="secondary" width="full">
